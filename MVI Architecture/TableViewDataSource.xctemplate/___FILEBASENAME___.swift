...
public class ___FILEBASENAMEASIDENTIFIER___: NSObject, UITableViewDataSource {

  private let dataSet: ObservableList<___VARIABLE_entityClass___>

  public init(dataSet: ObservableList<___VARIABLE_entityClass___>) {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt: indexPath: IndexPath) -> UITableViewCell {
    ...
    fatalError("we could not resolve cell as \(___VARIABLE_cellClass___) for \(identifier)")
  }
